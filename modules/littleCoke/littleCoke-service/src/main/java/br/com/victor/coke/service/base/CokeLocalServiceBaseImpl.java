...
public abstract class CokeLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CokeLocalServiceImpl#deleteCoke(Coke) to avoid orphaned data");
		}
	...
	protected void deactivate() {
		CokeLocalServiceUtil.setService(null);
	}
	...
	public void setAopProxy(Object aopProxy) {
		...
		CokeLocalServiceUtil.setService(cokeLocalService);
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CokeLocalServiceBaseImpl.class);
