...
public class CokeModelImpl extends BaseModelImpl<Coke> implements CokeModel {
	...
	private static Function<InvocationHandler, Coke>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			Coke.class.getClassLoader(), Coke.class, ModelWrapper.class);

		try {
			Constructor<Coke> constructor =
				(Constructor<Coke>)proxyClass.getConstructor(
	...
	public String toXmlString() {
		...
		for (Map.Entry<String, Function<Coke, Object>> entry :
			...
			sb.append(attributeGetterFunction.apply((Coke)this));
	...
	public <T> T getColumnValue(String columnName) {
		...
		Function<Coke, Object> function = _attributeGetterFunctions.get(
			columnName);
