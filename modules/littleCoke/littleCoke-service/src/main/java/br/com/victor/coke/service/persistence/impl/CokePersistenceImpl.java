...
import br.com.victor.coke.service.persistence.CokeUtil;
...
/**
 * The persistence implementation for the coke service.
 *
 * <p>
...
public class CokePersistenceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>CokeUtil</code> to access the coke persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		CokeImpl.class.getName();
	 ...
	 */
	@Override
	public List<Coke> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<Coke> findByUuid(String uuid, int start, int end) {
	...
	public List<Coke> findByUuid(
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_COKE_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(CokeModelImpl.ORDER_BY_JPQL);
			}
	...
	public Coke findByUuid_First(
		...
		Coke coke = fetchByUuid_First(uuid, orderByComparator);
		...
		throw new NoSuchCokeException(sb.toString());
	}
	...
	public Coke fetchByUuid_First(
		...
		List<Coke> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	public Coke findByUuid_Last(
		...
		Coke coke = fetchByUuid_Last(uuid, orderByComparator);
	...
	public Coke fetchByUuid_Last(
		...
		List<Coke> list = findByUuid(uuid, count - 1, count, orderByComparator);
	...
	public Coke[] findByUuid_PrevAndNext(
		...
		Coke coke = findByPrimaryKey(cokeId);
		...
		try {
			...
			Coke[] array = new CokeImpl[3];

			array[0] = getByUuid_PrevAndNext(
				session, coke, uuid, orderByComparator, true);

			array[1] = coke;

			array[2] = getByUuid_PrevAndNext(
				session, coke, uuid, orderByComparator, false);
	...
	protected Coke getByUuid_PrevAndNext(
		Session session, Coke coke, String uuid,
		OrderByComparator<Coke> orderByComparator, boolean previous) {
		...
		if (orderByComparator != null) {
			for (Object orderByConditionValue :
					orderByComparator.getOrderByConditionValues(coke)) {

				queryPos.add(orderByConditionValue);
			}
		}

		List<Coke> list = query.list();
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_COKE_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "coke.uuid = ?";

	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(coke.uuid IS NULL OR coke.uuid = '')";
	...
	public Coke findByUUID_G(String uuid, long groupId)
		...
		Coke coke = fetchByUUID_G(uuid, groupId);
	...
	public Coke fetchByUUID_G(
		...
		if (result instanceof Coke) {
			Coke coke = (Coke)result;

			if (!Objects.equals(uuid, coke.getUuid()) ||
				(groupId != coke.getGroupId())) {
	...
	public Coke removeByUUID_G(String uuid, long groupId)
		...
		Coke coke = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(coke.uuid IS NULL OR coke.uuid = '') AND ";
	 ...
	 */
	@Override
	public List<Coke> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	...
	public Coke findByUuid_C_First(
		...
		Coke coke = fetchByUuid_C_First(uuid, companyId, orderByComparator);
	...
	public Coke findByUuid_C_Last(
		...
		Coke coke = fetchByUuid_C_Last(uuid, companyId, orderByComparator);
	...
	public Coke[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, coke, uuid, companyId, orderByComparator, true);

			array[1] = coke;

			array[2] = getByUuid_C_PrevAndNext(
				session, coke, uuid, companyId, orderByComparator, false);
	...
	protected Coke getByUuid_C_PrevAndNext(
		Session session, Coke coke, String uuid, long companyId,
		OrderByComparator<Coke> orderByComparator, boolean previous) {
	...
	public CokePersistenceImpl() {
		...
		setModelClass(Coke.class);

		setModelImplClass(CokeImpl.class);
		setModelPKClass(long.class);

		setTable(CokeTable.INSTANCE);
	}
	...
	public void cacheResult(Coke coke) {
		entityCache.putResult(CokeImpl.class, coke.getPrimaryKey(), coke);

		finderCache.putResult(
			_finderPathFetchByUUID_G,
			new Object[] {coke.getUuid(), coke.getGroupId()}, coke);
	}
	 ...
	 */
	@Override
	public void cacheResult(List<Coke> cokes) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (cokes.size() > _valueObjectFinderCacheListThreshold))) {

			return;
		}

		for (Coke coke : cokes) {
			if (entityCache.getResult(CokeImpl.class, coke.getPrimaryKey()) ==
					null) {
	...
	/**
	 * Clears the cache for all cokes.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(CokeImpl.class);

		finderCache.clearCache(CokeImpl.class);
	}

	/**
	 * Clears the cache for the coke.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	 */
	@Override
	public void clearCache(Coke coke) {
		entityCache.removeResult(CokeImpl.class, coke);
	}

	@Override
	public void clearCache(List<Coke> cokes) {
		for (Coke coke : cokes) {
			entityCache.removeResult(CokeImpl.class, coke);
		}
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(CokeImpl.class, primaryKey);
		}
	}

	protected void cacheUniqueFindersCache(CokeModelImpl cokeModelImpl) {
		Object[] args = new Object[] {
			cokeModelImpl.getUuid(), cokeModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(_finderPathFetchByUUID_G, args, cokeModelImpl);
	}
	...
	public Coke create(long cokeId) {
		Coke coke = new CokeImpl();

		coke.setNew(true);
		coke.setPrimaryKey(cokeId);

		String uuid = PortalUUIDUtil.generate();

		coke.setUuid(uuid);

		coke.setCompanyId(CompanyThreadLocal.getCompanyId());
	...
	public Coke remove(long cokeId) throws NoSuchCokeException {
		return remove((Serializable)cokeId);
	}

	/**
	 * Removes the coke with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the coke
	 * @return the coke that was removed
	 * @throws NoSuchCokeException if a coke with the primary key could not be found
	 */
	@Override
	public Coke remove(Serializable primaryKey) throws NoSuchCokeException {
		Session session = null;

		try {
			session = openSession();

			Coke coke = (Coke)session.get(CokeImpl.class, primaryKey);
			...
			if (coke == null) {
				...
				throw new NoSuchCokeException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(coke);
		}
		catch (NoSuchCokeException noSuchEntityException) {
	...
	@Override
	protected Coke removeImpl(Coke coke) {
		Session session = null;

		try {
			session = openSession();

			if (!session.contains(coke)) {
				coke = (Coke)session.get(
					CokeImpl.class, coke.getPrimaryKeyObj());
			}
	...
	public Coke updateImpl(Coke coke) {
		boolean isNew = coke.isNew();

		if (!(coke instanceof CokeModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(coke.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(coke);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in coke proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom Coke implementation " +
					coke.getClass());
		}

		CokeModelImpl cokeModelImpl = (CokeModelImpl)coke;

		if (Validator.isNull(coke.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (coke.getCreateDate() == null)) {
			if (serviceContext == null) {
				coke.setCreateDate(date);
			}
			else {
				coke.setCreateDate(serviceContext.getCreateDate(date));
			}
		}

		if (!cokeModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				coke.setModifiedDate(date);
			}
			else {
				coke.setModifiedDate(serviceContext.getModifiedDate(date));
			}
		}
		...
		entityCache.putResult(CokeImpl.class, cokeModelImpl, false, true);

		cacheUniqueFindersCache(cokeModelImpl);

		if (isNew) {
			coke.setNew(false);
		}

		coke.resetOriginalValues();

		return coke;
	}

	/**
	 * Returns the coke with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the coke
	 * @return the coke
	 * @throws NoSuchCokeException if a coke with the primary key could not be found
	 */
	@Override
	public Coke findByPrimaryKey(Serializable primaryKey)
		throws NoSuchCokeException {

		Coke coke = fetchByPrimaryKey(primaryKey);
	...
	public Coke findByPrimaryKey(long cokeId) throws NoSuchCokeException {
		return findByPrimaryKey((Serializable)cokeId);
	}
	...
	public Coke fetchByPrimaryKey(long cokeId) {
		return fetchByPrimaryKey((Serializable)cokeId);
	}
	 ...
	 */
	@Override
	public List<Coke> findAll(int start, int end) {
	...
	public List<Coke> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sql = _SQL_SELECT_COKE;

				sql = sql.concat(CokeModelImpl.ORDER_BY_JPQL);
			}
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_COKE);
	...
	protected String getSelectSQL() {
		return _SQL_SELECT_COKE;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return CokeModelImpl.TABLE_COLUMNS_MAP;
	}

	/**
	 * Initializes the coke persistence.
	 */
	@Activate
	...
	private static final String _SQL_SELECT_COKE = "SELECT coke FROM Coke coke";

	private static final String _SQL_SELECT_COKE_WHERE =
		"SELECT coke FROM Coke coke WHERE ";

	private static final String _SQL_COUNT_COKE =
		"SELECT COUNT(coke) FROM Coke coke";

	private static final String _SQL_COUNT_COKE_WHERE =
		"SELECT COUNT(coke) FROM Coke coke WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS = "coke.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No Coke exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No Coke exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		CokePersistenceImpl.class);
