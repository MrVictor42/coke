...
public class UserCokeLocalServiceWrapper
	...
	@Override
	public br.com.victor.coke.model.UserCoke createUserCook(
		long cokeId, long userId, long addedBy) {

		return _userCokeLocalService.createUserCook(cokeId, userId, addedBy);
	}
